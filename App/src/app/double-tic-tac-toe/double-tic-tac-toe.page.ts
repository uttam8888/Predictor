...
@Component({
  selector: 'app-double-tic-tac-toe',
  templateUrl: './double-tic-tac-toe.page.html',
  styleUrls: ['./double-tic-tac-toe.page.scss'],
})
export class DoubleTicTacToePage implements OnInit {
